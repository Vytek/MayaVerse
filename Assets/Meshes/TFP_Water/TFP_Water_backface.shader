    ...
    SubShader {
        ...
        Pass {
            ...
            fixed4 frag(VertexOutput i) : COLOR {
                ...
                float4 node_6224 = _Time + _TimeEditor;
                float node_3186 = 5.0;
                float2 node_8616 = ((i.uv0*objScale.r*node_3186)+node_6224.g*float2(0,0.12));
                float3 node_5329 = UnpackNormal(tex2D(_Water01,TRANSFORM_TEX(node_8616, _Water01)));
                float2 node_7137 = ((i.uv0*objScale.r*node_3186)+node_6224.g*float2(0.12,-0.12));
...
////// Lighting:
                float3 finalColor = 0;
                float node_5505 = 0.0;
                fixed4 finalRGBA = fixed4(lerp(sceneColor.rgb, finalColor,node_5505),1);
